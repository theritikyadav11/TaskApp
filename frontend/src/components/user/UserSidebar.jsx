...
const menu = [
  ...
  { path: "/user/tasks", label: "Task Management" },
  { path: "/user/priority", label: "Priority Management" },
];
...
export default function UserSidebar() {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-gray-900 text-white flex flex-col py-8 px-4
